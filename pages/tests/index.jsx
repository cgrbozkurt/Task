...
const GetSupport = () => {
  return (
    <section className='mt-36 mb-24 flex lg:flex-row flex-col lg:gap-1 gap-5 justify-between mx-12   '>
        ...
        <SupportItem>  <Image className=' w-16 mb-5 '  src={"/images/benefit-1.webp"} width={62} height={62} />
        ...
        <SupportItem>   <Image className=' w-16  mb-5 pb-4'  src={"/images/benefit-2.webp"} width={62} height={62} />
        ...
        <SupportItem> <Image className=' w-16 mb-5'  src={"/images/benefit-3.webp"} width={62} height={62} />
            ...
            <SupportItem>  <Image className='  w-16 mb-5'  src={"/images/benefit-4.webp"} width={62} height={62} />
