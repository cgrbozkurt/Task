    ...
    <div className="jobs-card w-[338px] h-[524px] rounded-xl flex flex-col items-center border p-5 ">
      <div className="jc-top h-[115px] w-[115px] rounded-full border-2 border-jobsborder flex justify-center relative">
        <Link className="" href={"#"}>
          <Image
            ...
            src={"/images/gulcolak.png"}
            width={111}
            height={111}
            alt="Gul Colak"
          />
        </Link>
        <div className="w-5 h-5 rounded-full bg-jobsborder border-4 border-white absolute top-2 right-1"></div>
      </div>
      <span
        className="w-[78px] h-[24px] -mt-[12px] text-jobsborder relative border border-jobsborder bg-ajobbg rounded-full
     text-[0.75rem] flex justify-center text-center  "
      ...
      <Link
        ...
        href={"https://hidoctor.health/online/psikolog/cagla-demirel"}
      >
        Çağla Demirel
      </Link>
      <span className="text-[12px] mt-2">Psikolog | Aile Danışmanı</span>
     ...
     <span>TR | EN</span>
      ...
      <div className="specialitis w-[305px] h-[96px] grid grid-cols-3 items-center gap-4 mx-auto "> 
      <Link className="w-[56px] h-[32px] bg-slate-400 " href={"#"}>asdfasdf</Link>
      <Link className="w-[56px] h-[32px] bg-slate-400 " href={"#"}>asdfasdf</Link>
      <Link className="w-[56px] h-[32px] bg-slate-400 " href={"#"}>asdfasdf</Link>
      <Link className="w-[56px] h-[32px] bg-slate-400 " href={"#"}>asdfasdf</Link>
...
<span className="mt-3"> 370₺ minimum tutar</span>
<Link className="w-[256px] h-[32px] bg-jobsborder rounded-full flex items-center justify-center mt-5 " href={"#"}>Hemen Başla</Link>
    </div>
  );
};
